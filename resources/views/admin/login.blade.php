    ...
    <div class="container">
            ...
            <div class="signin-signup">
                ...
                <form action="{{route('admin.login')}}" method="POST" class="sign-in-form">
                    ...
                    <h2 class="title"><img class="ms-user-img  ms-lock-screen-user"
                            src="{{ url('/assets/img/logo_black.png') }}" height="100" width="200" alt="people">
                    </h2>
                    <h2 class="title">Sign in</h2>
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" placeholder="Email Id" name="user_mail" required />
                    </div>
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" placeholder="Password" id="txtPassword1" name="user_password" required />
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="{{ url('assets/img/Privacy-policy-rafiki.png') }}" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                ...
                <img src="{{ url('assets/img/Mobile-login-rafiki.png') }}" class="image" alt="" />
            </div>
        </div>
    </div>
