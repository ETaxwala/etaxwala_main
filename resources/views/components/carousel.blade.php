    ...
    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img src="{{ url(env('LINK') . 'img/carousel-2.jpg') }}" class="img-fluid" alt="Image">
                <div class="carousel-caption">
                    <div class="text-center p-4" style="max-width: 900px;">
                       <h1 class="display-2 text-capitalize text-white mb-3 mb-md-4 wow fadeInUp" data-wow-delay="0.3s">Your Trusted Partner in Business Consultancy</h1>
