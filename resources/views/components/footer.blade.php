         ...
         <div class="row g-5">
             <div class="col-md-6 col-lg-6 col-xl-4">
                 <div class="footer-item d-flex flex-column">
                     ...
                     <a href=""><i class="fa fa-map-marker-alt me-2"></i> Office No.2, KP Heritage, Beed Bypass Rd,
                         beside Alpine Hospital, opp.
                         MIT College, Jai Nagri, Ch Sambhajinagar, Maharashtra 431001</a>
